...
public class SiaranListAdapter extends BaseAdapter {
    private Activity activity;
    private LayoutInflater inflater;
    private List<ModelSiaran> modelSiaranList;

    public SiaranListAdapter(Activity activity, List<ModelSiaran> modelSiaranList)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) convertView = inflater.inflate(R.layout.adapter_siaran, null);
